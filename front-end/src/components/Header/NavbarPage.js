    ...
    <Navbar className="bg-white text-gray-600">
      ...
      <NavbarCollapse>
        <NavbarNav orientation="start">
          <NavbarItem>
            <NavbarLink href="#">Project Name</NavbarLink>
          </NavbarItem>
        </NavbarNav>
        <NavbarNav orientation="end">
          ...
          <NavbarItem>
            <NavbarLink href="#">Summarize</NavbarLink>
          </NavbarItem>
...
const style = {
  navbar: `fixed px-4 py-2 top-0 w-full lg:flex lg:flex-row lg:items-center lg:justify-start lg:relative`,
